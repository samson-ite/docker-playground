...
pipeline {
	...
	task_def_arn = "arn:aws:ecs:us-east-1:159647148516:task-definition/first-run-task-definition"
	cluster = "docker-playground"
	exec_role_arn = "arn:aws:iam::159647148516:role/ecsTaskExecutionRole"
    }
